...
import 'file:///C:/ornekler/otomobil_bilgi_sistemi/lib/menu/girisekrani.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(color: Colors.teal[100], child: _SignInBody()),
    );
  }
}
              ...
              Container(
                ...
                child: GestureDetector(
                  ...
                  child: SignInButton(Buttons.Email,
                      text: "Email ile giriş yap", onPressed: () {}),
                ),
              ),
            ],
          ),
